...
export interface UserPreferences {
  ...
  selectedTimeTracking?: 'all' | 'tracking' | 'not-tracking'; // Filter: active time tracking state
  selectedTimeRange?: {
  ...
  mcpApiKeySetAt?: string; // ISO timestamp when key was set
}
